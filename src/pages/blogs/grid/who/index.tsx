    ...
    <div className={Style.container}>
      ...
      <div className={Style.textContainer}>
        <p className={Style.p}>
          ...
          <br />
          We regularly ask our customers for the feedbacks. This health check is
          an absolute must for every product. <br />
        ...
        <p className={Style.p}>
          User portraits:
          <br /> Kaven, I'm a designer. My trouble is: the image results output
          by the smart platform are very single. So I want: Multiple output
          options; The platform to learn and communicate; Preview output styles.
          Therefore, Img50% enhancer can help me choose a suitable output image,
          and there is also a comment area, where I can directly feedback and
          interact on the web page, and the reply and improvement are more
          timely, which helps to prolong the vitality of the product.
        </p>
        ...
        <p className={Style.p}>
          ...
          Steven: I think your service is wonderful! It makes it easy for people
          to save improved pictures so that their visual strength is preserved.
          I do like the fact that you can improve photos, and I have to say that
          I was pretty blown away by the results I've seen. <br />
          ...
          especially since I prefer open source platforms. I like this blog the
          most! ! <br />
