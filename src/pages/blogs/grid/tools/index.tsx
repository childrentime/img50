      ...
      <div className={Style.textContainer}>
        ...
        <div className={Style.compare}>
          ...
          <p className={Style.p}>
            ...
            laid out, and Fireblde can be used to generate code for static pages
            with one click, which is more intuitive. It can create various
            dynamic effects, realize switching and jumping, and supports a wide
            range of plug-ins.
          </p>
        </div>
        <div className={Style.compare}>
        ...
        <div className={Style.h1}>2. Web front-end tool selection: Vscode</div>
        <div className={Style.compare}>
          ...
          <p className={Style.p}>
            ...
            Platform:Microsoft's software development platform supports all .net
            programming in languages such as C, C, VB, F, J, HTML, XML,
            javascript, and more. Compatibility:Compatible with other things
            related to .net development, such as crystal reports, ajax, JQuery,
            and so on. Resource usage:Free open source modern lightweight code
            editor.
          </p>
        </div>
        <div className={Style.compare}>
