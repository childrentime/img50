      ...
      <div className={Style.container}>
        ...
        <div className={Style.textContainer}>
          ...
          <p className={Style.p}>
            ...
            phone. Without good photography skills, it is easy to end up with
            poor quality photos that are not in focus or exposed correctly.
            Research has shown that image editing software such as Photoshop can
            usually improve image quality. Some studies have shown that image
            editing software such as Photoshop can usually improve image
            quality, but professional image editing programs are very expensive
            and the use of these complex programs requires a certain level of
            basic expertise and time-consuming work. Therefore, we have
            developed an image correction tool based on Deep Learning to improve
            image quality.
          </p>
